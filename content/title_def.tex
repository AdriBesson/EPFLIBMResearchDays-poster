...
\author[short-author]{ % [short-author] is optional (used with \insertshortauthor)
	...
	\href{mailto:matthieu.simeoni@epfl.ch}{Matthieu Simeoni\inst{\dagger}\inst{\ast}},
...
\institute{
	...
	\inst{\ast}Audiovisual Communications Laboratory (LCAV), École Polytechnique Fédérale de Lausanne (EPFL), Lausanne \\
